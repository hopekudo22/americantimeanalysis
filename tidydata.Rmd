...
sleep1 <- data %>%
  select(state, sleep) %>%
  group_by(state) %>%
  summarise(mean(sleep, na.rm = TRUE)) 
...
housework1 <- data %>%
  ...
  group_by(state) %>%
  summarise(mean(housework, na.rm = TRUE)) 
...
phonetime1 <- data %>%
  ...
  group_by(state) %>%
  summarise(mean(phonetime, na.rm = TRUE))
...
volunteer1 <- data %>%
  ...
  group_by(state) %>%
  summarise(mean(volunteer, na.rm = TRUE))
...
sports1 <- data %>%
  select(state, sports) %>%
  group_by(state) %>%
  summarise(mean(sports, na.rm = TRUE))
...
religion1 <- data %>%
  ...
  group_by(state) %>%
  summarise(mean(religion, na.rm = TRUE))
...
eating1 <- data %>%
  select(state, eating) %>%
  group_by(state) %>%
  summarise(mean(eating, na.rm = TRUE))
...
shopping1 <- data %>%
  ...
  group_by(state) %>%
  summarise(mean(shopping, na.rm = TRUE))
...
researchhomework1 <- data %>%
  ...
  group_by(state) %>%
  summarise(mean(research_homework, na.rm = TRUE))
...
class1 <- data %>%
  select(state, class) %>%
  group_by(state) %>%
  summarise(mean(class, na.rm = TRUE))
...
working1 <- data %>%
  ...
  group_by(state) %>%
  summarise(mean(working, na.rm = TRUE))
...
druguse1 <- data %>%
  ...
  group_by(state) %>%
  summarise(mean(druguse, na.rm = TRUE))
...
computeruse1 <- data %>%
  ...
  group_by(state) %>%
  summarise(mean(computeruse, na.rm = TRUE)) 
...
```{r}
write.csv(combo13, "TimeAnalysis/combo13.csv")
```
